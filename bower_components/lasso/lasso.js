d3.lasso = function() {
    ...
    function lasso() {
        ...
        var flag = 0;
        function dragstart() {
            //set the shape of mouse
            d3.select('body').style('cursor', 'cell');
            flag = 0;
        ...
        function dragmove() {
            ...
            {
                var lassoPosition = [];
                lassoPosition[0] = d3.event.sourceEvent.clientX;
                lassoPosition[1] = d3.event.sourceEvent.clientY;
                Variables.set('lassoPosition', lassoPosition);
                flag = 1;
            }
        ...
        function dragend() {
            ...
            // Tag selected items
            items.filter(function(d,i) {return d.possible === true;})
